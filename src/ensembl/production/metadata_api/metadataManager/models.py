...
class Assembly(Base):
    ...
    assembly_id = Column(INTEGER(11), primary_key=True)
...
class DatasetSource(Base):
    ...
    dataset_source_id = Column(INTEGER(11), primary_key=True)
...
class DatasetType(Base):
    ...
    dataset_type_id = Column(INTEGER(11), primary_key=True)
...
class Organism(Base):
    ...
    organism_id = Column(INTEGER(11), primary_key=True)
    taxonomy_id = Column(INTEGER(11), nullable=False)
    species_taxonomy_id = Column(INTEGER(11))
...
class OrganismGroup(Base):
    ...
    organism_group_id = Column(INTEGER(11), primary_key=True)
    type = Column(String(32), nullable=False)
...
class AssemblySequence(Base):
    ...
    assembly_sequence_id = Column(INTEGER(11), primary_key=True)
    ...
    length = Column(INTEGER(11), nullable=False)
...
class Dataset(Base):
    ...
    dataset_id = Column(INTEGER(11), primary_key=True)
...
class EnsemblRelease(Base):
    ...
    release_id = Column(INTEGER(11), primary_key=True)
...
class Genome(Base):
    ...
    genome_id = Column(INTEGER(11), primary_key=True)
...
class OrganismGroupMember(Base):
    ...
    organism_group_member_id = Column(INTEGER(11), primary_key=True)
...
class DatasetAttribute(Base):
    ...
    dataset_attribute_id = Column(INTEGER(11), primary_key=True)
    type = Column(String(32), nullable=False)
...
class GenomeDataset(Base):
    ...
    genome_dataset_id = Column(INTEGER(11), primary_key=True)
    dataset_id = Column(ForeignKey('dataset.dataset_id'), nullable=False, index=True)
...
class GenomeRelease(Base):
    ...
    genome_release_id = Column(INTEGER(11), primary_key=True)
    genome_id = Column(ForeignKey('genome.genome_id'), nullable=False, index=True)
    release_id = Column(ForeignKey('ensembl_release.release_id'), nullable=False, index=True)
    is_current = Column(TINYINT(1), nullable=False)
